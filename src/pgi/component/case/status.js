...
class Status extends Component {
    ...
    componentWillMount() {
        ...
        this.clearAllCookie()
        reqwest({
            //url: 'https://premedkb.cn/api/checkValid',
            url: 'https://47.101.51.25/api/checkValid',
            method: 'post',
            headers: {
                    ...
                    this.state.status == 2 ? (
                        <div>
                            <div className="status-content">
                                ...
                                <a onClick={this.showModal}> https://premedkb.cn/poi/#{this.state.url} </a>
                                ...
                                <Modal title="Notice" visible={this.state.modal} okText="Go" onOk={this.handleOk} onCancel={this.handleCancel}>
                                    ...
                                    <Link to={this.state.url}> https://premedkb.cn/poi/#{this.state.url} </Link>
                                ...
                                <p style={{ marginTop: '12px' }}>2. All information, including input data and interpretation reports, will be deleted <b>within 7 days.</b></p>
