...
const PgiDetails = Loadable({
    loader: () => import('pgi/view/case/details'),
    loading: () => null
});
const PgidrDetails = Loadable({
    loader: () => import('pgi/view/case/drdetails'),
    loading: () => null
});
const PgiieDetails = Loadable({
    loader: () => import('pgi/view/case/iedetails'),
    loading: () => null
});
...
const PgiCaseExpbp = Loadable({
    loader: () => import('pgi/view/case/expbp'),
    loading: () => null
});
                ...
                <div className="g-bd">
                    ...
                    <div className="g-mn">
                        <Switch>
                            ...
                            <Route path={ROUTER_PATHS.PGI_CASE_DETAILS} component={PgiDetails} />
                            <Route path={ROUTER_PATHS.PGI_CASE_DRDETAILS} component={PgidrDetails} />
                            <Route path={ROUTER_PATHS.PGI_CASE_IEDETAILS} component={PgiieDetails} />
                            <Route path={ROUTER_PATHS.PGI_CASE_EXPBP} component={PgiCaseExpbp} />
                        </Switch>
                    </div>
                    <Footer />
                </div>
